...
class IhTitle extends StatelessWidget {
  final bool isReorderMode;
  final VoidCallback? onPressed;

  const IhTitle({super.key, required this.isReorderMode, this.onPressed});
      ...
      children: [
        Expanded(
          child: Row(
            ...
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              Image.asset('assets/icons/ih.png', width: 30),
              Expanded(
                child: Text(
                  CorporationType.ih.korean,
